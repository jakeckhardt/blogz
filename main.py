...
def blog():
    ...
    return render_template("blog.html", blog=get_blog_list(), entry_id=entry_id, users=get_user_list())
...
def index():
    ...
    return render_template("index.html", user=get_user_list(), user_id=user_id)
